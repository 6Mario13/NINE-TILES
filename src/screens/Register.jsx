...
export const Register = () => {
  ...
  return (
    <div className="bg-gray-100">
      <div className="flex justify-center py-3 sm:py-12 " >
      ...
      <div className=" mx-auto w-full sm:w-4/5 lg:w-1/2 pb-24">
        <h1 className="text-3xl text-center pb-8">Create new account</h1>
        <div className="mx-4 border rounded-3xl drop-shadow-lg space-y-6 p-8 bg-white" action="#" method="POST">
          <div>
